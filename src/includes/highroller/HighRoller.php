<?php
/**
 * Changes have been made to this file by Tyler Blair <hidendra@griefcraft.com> to
...
//    $this->plotOptions = new HighRollerPlotOptions($this->chart->type);
   ...
   */
  function renderChart($chart = 'highcharts', $engine = 'jquery'){
    ...
    */
    ...
    $chartJS .= "\n    var " . $this->chart->renderTo . " = new Highcharts.$classname(\n";
